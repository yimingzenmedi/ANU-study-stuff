...
public class Parcel implements Comparable<Parcel> {
	...
	public int compareTo(Parcel other) {
		...
		double thisDistance = warehouse.getDistance(this.sender.getLocation()) + warehouse.getDistance(this.recipient.getLocation());
		double otherDistance = warehouse.getDistance(other.sender.getLocation()) + warehouse.getDistance(other.recipient.getLocation());
