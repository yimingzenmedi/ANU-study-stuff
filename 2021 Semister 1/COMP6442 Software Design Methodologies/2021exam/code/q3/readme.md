...
All parcels must pass through a common warehouse located at **\[105,15\]** (as seen in general case below). Distance is calculated using the standard Euclidean distance:
...
**Example 1:** Sender is at position [75,55], Recipient is at position [155,135]

![ParcelExample1](./parcel/ParcelExample1.png)

**Example 2:** Sender is at position [117,10], Recipient is at position [265,-285]
...
- The **distance from the Sender to the Recipient** (highlighted in green in the above image) is in **ascending** order

Hence since 50km+130km is less than 13km+340km, then we know that the parcel in Example 1 should come before the parcel in Example 2.
