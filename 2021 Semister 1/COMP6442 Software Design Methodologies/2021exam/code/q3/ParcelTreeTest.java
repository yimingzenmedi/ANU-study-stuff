...
public class ParcelTreeTest {
    ...
    public void initTestVariables() {
        ...
        warehouseLocation = new CartesianCoordinate(105,15);
    }
    ...
    public void parcelOderTest5() {
        assertTrue("The distance from the sender of parcel 1 to the recipient of parcel 1 should be less than the distance " +
                "from the sender of parcel 8 to the recipient of parcel 8",parcel1.compareTo(parcel8) < 0);
        assertTrue("The distance from the sender of parcel 1 to the recipient of parcel 1 should be less than the distance " +
                "from the sender of parcel 6 to the recipient of parcel 6", parcel1.compareTo(parcel6) < 0);
        assertTrue("The distance from the sender of parcel 5 to the recipient of parcel 5 should be less than the distance " +
                "from the sender of parcel 6 to the recipient of parcel 6", parcel6.compareTo(parcel5) > 0);
    }
    ...
    public void parcelOrderTest6() {
        ...
        List<Parcel> expectedSortedParcels =
                Arrays.asList(parcel9,parcel4,parcel1,parcel5,parcel8,parcel7,parcel6,parcel3,parcel10,parcel2);
    ...
    public void parcelOrderTest7() {
        ...
        assertEquals("Minimum value in tree not correct, Hence implemented Parcel ordering is not correct",parcel9,parcelTree.min());
