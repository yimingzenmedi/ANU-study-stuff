...
//		System.out.println("\nINSERT " + d + " TO " + this.data);
		if (d.compareTo(this.data) < 0) {
//			System.out.println(d + " is smaller than " + this.data);
			if (this.left.isEmpty()) {
//				System.out.println("Empty left subtree");
				this.left = new NonEmptyBinaryTree<T>(d);
			} else {
//				System.out.println("Non-empty left subtree");
				this.left.insert(d);
			}
		} else if (d.compareTo(this.data) > 0) {
//			System.out.println(d + " is larger than " + this.data);
			if (this.right.isEmpty()) {
//				System.out.println("Empty right subtree");
				this.right = new NonEmptyBinaryTree<T>(d);
			} else {
//				System.out.println("Non-empty right subtree");
				this.right.insert(d);
			}
		}
//		else {
//			System.out.println(d + " is equal to " + this.data);
//		}
		return this;
		// ########## YOUR CODE ENDS HERE ##########
	}
	...
	public BinaryTree<T> delete(T d) {
		// TODO: Add your implementation here
		// ########## YOUR CODE STARTS HERE ##########
		System.out.println("Deleting: " + d.toString());
		if (!this.find(d)) return this;
		if (d.compareTo(this.data) == 0) {
			if (this.left.isEmpty() && this.right.isEmpty()) {
				...
				System.out.println("Right: " + this.right.preOrderShow());
				return this.right;
			} else {
				System.out.println(4);
				this.data = this.right.smallest();
				this.right = this.right.delete(this.right.smallest());
			}
		} else if (d.compareTo(this.data) < 0) {
