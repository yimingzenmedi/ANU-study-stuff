...
//		System.out.println("\nSearch: x: " + x + ", y: " + y);
		Node xNode = this.find(x);
		Node yNode = this.find(y);

		while (xNode != null) {
//			System.out.println("xNode: " + xNode.key);
			while (yNode != null) {
//				System.out.println("yNode: " + yNode.key + "(xNode: " + xNode.key + ")");
				if (xNode.key.equals(yNode.key)) {
					return xNode.key;
				}
				yNode = yNode.parent;
			}
