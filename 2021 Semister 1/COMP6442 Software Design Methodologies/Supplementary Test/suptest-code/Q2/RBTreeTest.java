...
//	}
	...
	public void setUp() {
		tree = new RBTree<>();
		Node.PersonName<String> node1 = new Node.PersonName<>("Tyson", "Terrell");
		Node.PersonName<String> node2 = new Node.PersonName<>("John", "Evison");
		Node.PersonName<String> node3 = new Node.PersonName<>("Maxwell", "Williams");
		tree.insert(node2,"Watson");
		tree.insert(node3,"Braddon");
		tree.insert(node1,"Acton");
	...
	@Test(timeout=1000)
	public void testInsert() {
		Assert.assertEquals("(Tyson,Terrell,Acton) (John,Evison,Watson) (Maxwell,Williams,Braddon)", tree.preOrder());
	}
}
