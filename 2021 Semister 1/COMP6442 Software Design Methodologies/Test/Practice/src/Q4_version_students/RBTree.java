...
public class RBTree<T extends Comparable<T>> {
	...
	public class Node<E extends Comparable<E>> {
		...
		public boolean isOK() {
			System.out.println("\nValue: " + this.value + ", from: " + (this.parent != null ? this.parent.value : "null"));
			if (this.value == null) {
...
//			}
			if (this.left.value != null && this.right.value != null) {
				System.out.println("0. L: " + this.left.blackParentCount() + ", R: " + this.right.blackParentCount());
				System.out.println("LV: " + this.left.value + ", RV: " + this.right.value);
				if (this.left.blackParentCount() != this.right.blackParentCount()) {
					return false;
				}
			}

			if (this.left.value == null && this.right.value != null) {
				System.out.println("1. L: " + this.blackParentCount() + ", R: " + this.right.blackParentCount());
				if (this.right.blackParentCount() != this.blackParentCount()) {
					return false;
				}
			}

			if (this.right.value == null && this.left.value != null) {
				System.out.println("2. L: " + this.left.blackParentCount() + ", R: " + this.blackParentCount());
				if (this.left.blackParentCount() != this.blackParentCount()) {
					return false;
				}
			}
			if (!this.left.isOK()) {
