...
public class RBTree<T extends Comparable<T>> {
	...
	public boolean testProp1() {
		...
		return this.root.testProp1(); //you are allowed to change this return statement
		// END YOUR CODE
	}
	...
	public boolean testProp2() {
		...
		return this.root.testProp2(); //you are allowed to change this return statement
		// END YOUR CODE
	}
	...
	public class Node<E extends Comparable<E>> {
		...
		public boolean testProp1() {
			if (this.parent == null && this.colour == Colour.RED) {
			...
			if (this.left != null && this.right == null) {
				...
				return this.left.testProp1();
			}
			if (this.left == null) {
				System.out.println(1);
				return this.right.testProp1();
			}
			return this.left.testProp1() && this.right.testProp1();
		}

		public boolean testProp2() {
			if (this.colour == Colour.RED && this.parent.colour == Colour.RED) {
				return false;
			}
			boolean leftRes = true, rightRes = true;
			if (this.left != null) {
				leftRes = this.left.testProp2();
			}
			if (this.right != null) {
				rightRes = this.right.testProp2();
			}
