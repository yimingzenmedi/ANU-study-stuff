...
public class BinarySearchTest {
    ...
    public void TestSearch1(){
        int n = 1;
        Element<Integer> expected4 = new Element<Integer>(n, n+1);
        Element<Integer> actual4 = bs.search(testMatrix,0,9,0,9,n);
        assertEquals(expected4.key, actual4.key);
        assertEquals(expected4.value, actual4.value);
//        assertEquals(1, bs.search(testMatrix,0,9,0,9,1));
    }
