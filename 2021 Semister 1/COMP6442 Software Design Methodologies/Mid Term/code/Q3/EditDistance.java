    ...
    public static int minDistance(String seq1, String seq2){
        ...
        if (seq1 == null || seq1.isEmpty()) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                System.out.println("+" + EditCost.getInsertCost(index));
            }
            return distance;
        }
        ...
        for (int i = 1; i <= len1; i++) {
            ...
            for (int j = 1; j <= len2; j++) {
                if (seq1.charAt(i - 1) == seq2.charAt(j - 1)) {
                    ...
                    System.out.println("Same... " + cost[i - 1][j - 1]);
                } else {
                    ...
                    System.out.println("+replaceCost: " + replaceCost + ", +deleteCost: " + deleteCost + ", +insertCost: " + insertCost);
                }
            }
        }
