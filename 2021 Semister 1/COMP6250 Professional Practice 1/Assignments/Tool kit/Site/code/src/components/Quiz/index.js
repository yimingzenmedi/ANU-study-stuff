...
const questions = [
  ...
  },
  {
    ...
    quizzes: [
      {
        description: "Which of the following options are related to the importance of the stakeholder analysis?",
        options: [
          {
            key: 1,
            text: "Understanding the structure of the project."
          },
          {
            key: 2,
            text: "Predict what might happen during the project running."
          },
          {
            key: 3,
            text: "Analyse all stakeholder for making right decisions."
          }
        ],
        answer: [1, 2, 3],
        feedback: [
          {
            key: 1,
            text: "Before starting the project, you can understand the structure of the project and role of each stakeholder plays in this project."
          },
          {
            key: 2,
            text: "By understanding each stakeholder, it is so important for developer to predict what might happen and response in advance."
          },
          {
            key: 3,
            text: "Each stakeholder plays different role in a project, by analysing what effect each stakeholder might take, the developer can make the most suitable decision which is benefit for every stakeholder."
          }
        ]
      },
      {
    ...
    return (
      <div className={styles.quiz}>
        <p className={styles.quizDescription}>
          ...
          {quiz.description}
          {isMulti ? <b> (Please select multiple options)</b> : null}
        </p>
