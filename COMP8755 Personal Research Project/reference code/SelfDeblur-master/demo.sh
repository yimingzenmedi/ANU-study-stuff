...
python inference_demo.py --save_images --demo_data_dir=../demo/real --model_label=Fastec_pretrained --log_dir=../experiments/pretrained_models --results_dir=../experiments/results_demo_real
