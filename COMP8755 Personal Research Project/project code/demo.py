...
parser.add_argument('--model', required=True, type=int, help='Task to run: 1. MPRNet deblurring, 2. LTEVSFSMBI',
                    choices=[1, 2])
...
weights = os.path.join(task, "ckpt", task, "models", "MPRNet", "model_latest.pth")
