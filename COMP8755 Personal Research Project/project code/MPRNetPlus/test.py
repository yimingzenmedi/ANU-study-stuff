...
if args.index == 1 or args.index == 7:
    ckpt_path = f'./ckpt/MPRNetPlus/F17_{args.index}/F17_model_{args.index}_best.pth'
elif args.index == 2 or args.index == 6:
    ckpt_path = f'./ckpt/MPRNetPlus/F26_{args.index}/F26_model_{args.index}_best.pth'
elif args.index == 3 or args.index == 5:
    ckpt_path = f'./ckpt/MPRNetPlus/F35_{args.index}/F35_model_{args.index}_best.pth'
else:   # args.index == 4
    ckpt_path = f'./ckpt/MPRNetPlus/centerEsti/centerEsti_model_latest.pth'
