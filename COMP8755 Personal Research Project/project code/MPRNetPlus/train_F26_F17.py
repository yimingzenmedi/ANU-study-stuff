...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, opt.OPTIM.NUM_EPOCHS + 1):
        ...
        for i, data in enumerate(tqdm(train_loader), 0):
            ...
            loss = criterion(restored1, restored7, restored2, restored6, target1, target7, target2, target6) + dis_output_loss
            ...
            # print(f"> target6: {target6.shape}, labels6: {labels6.shape}, restored[0]: {restored[0].shape}, "
            #       f"dis_output6: {dis_output6.shape}, dis_output6_loss: {dis_output6_loss.shape}")
            ...
            # print(f"> target7: {target7.shape}, labels7: {labels7.shape}, restored[0]: {restored[0].shape}, "
            #       f"dis_output7: {dis_output7.shape}, dis_output7_loss: {dis_output7_loss.shape}")
