...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, pic_index=None, group=7, img_options=None):
    ...
    def __getitem__(self, index):
        ...
        # print(f"!!! index: {index}, index_: {index_}")
        ...
        if self.pic_index != None:
            tar_index_ = index_ * self.group + self.pic_index
        tar_path = self.tar_filenames[tar_index_]
        # print(f"!!! input path: {inp_path}, target path: {tar_path}")
...
class DataLoaderVal(Dataset):
    def __init__(self, rgb_dir, img_options=None, pic_index=None, group=7, rgb_dir2=None):
    ...
    def __getitem__(self, index):
        ...
        if self.ps is not None:
            ...
            if self.pic_index != None:
                tar_index_ = index_ * self.group + self.pic_index
            tar_img = TF.center_crop(tar_index_, (ps, ps))
