...
# CARN net, refer to Fig.3:
class CARN_M_Net(torch.nn.Module):
    def __init__(self, **kwargs):
        super(CARN_M_Net, self).__init__()
        ...
        self.entry = torch.nn.Conv2d(3, 64, 3, 1, 1)
        ...
        self.upsample = ops.UpsampleBlock(64, scale=scale, group=group)
        self.exit = torch.nn.Conv2d(64, 3, 3, 1, 1)
